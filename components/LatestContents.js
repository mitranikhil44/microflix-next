...
const LatestContents = ({ data }) => {
  ...
  return (
    <div className="relative h-auto">
      ...
      <h2 className="xl:text-3xl lg:text-2xl md:text-xl smd:text-lg text-sm text-white my-4">Latest Contents</h2>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
        centeredSlides={true}
          ...
          data.map((element, index) => (
            <SwiperSlide key={element._id}>
              <Link href={element.slug} className="h-auto">
                ...
                <div className="h-[75vh] smd:h-[55vh] md:h-[45vh] lg:h-[40vh] xl:[35vh]">
